...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Extension">
      <sch:assert test="count(f:extension[@url = 'http://loinc.org/99501-9/']) &gt;= 1">extension with URL = 'http://loinc.org/99501-9/': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://loinc.org/99501-9/']) &lt;= 1">extension with URL = 'http://loinc.org/99501-9/': maximum cardinality of 'extension' is 1</sch:assert>
